...
- Host key verification (connections accept any host key — same as the upstream TypeScript reference)
...
6. **Do not expose the HTTP daemon** (`start`) beyond `127.0.0.1` unless fronted by auth/TLS.
